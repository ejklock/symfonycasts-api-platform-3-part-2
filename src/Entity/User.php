...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?array $accessTokensScopes = null;
    ...
    {
        if (null === $this->accessTokensScopes) {

            $roles = $this->roles;
            $roles[] = 'ROLE_FULL_USER';
        } else {

            $roles = $this->accessTokensScopes;
        }
        $roles[] = 'ROLE_USER';
    ...
    public function getValidTokenStrings(): array
    {
        ...
        return $this->getApiTokens()
            ->filter(fn (ApiToken $apiToken) => $apiToken->isValid())
            ->map(fn (ApiToken $apiToken) => $apiToken->getToken())
            ->toArray();
    }

    public function markAsTokenAuthenticated(array $scopes): void
    {
        $this->accessTokensScopes = $scopes;
    }
